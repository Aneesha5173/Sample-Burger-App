...
class BurgerBuilder extends Component {
    ...
    purchaseHandler = () =>{ 
        if(this.props.isAuth){
            ...
            this.props.history.push('/auth'); //if we are authenticated after adding the ingredients then it shows the signin page
        }
        // this.setState({purchasing: true});
    }
            ...
            burger = (
                     <Aux>
                         ...
                         <BuildControls 
                              ...
                              isAuthunicated = {this.props.isAuth}
...
const mapDispatchToProps = dispatch => {
    return{
        ...
        onSetRedirectAuthPath : (path) => dispatch(burgerActions.setAuthRedirectPath(path))
    }
}
